...
Measured on 0v0 with Lean 4.28.0-rc1, using `lake build ram-demo` and the native
...
| --- | ---: | ---: | ---: | ---: |
| Fast | 1,000 | 26,019 | 499,500 | 1.769021 ms |
| Reference | 1,000 | 26,019 | 499,500 | 226.862228 ms |
| Fast | 100,000 | 2,600,019 | 4,999,950,000 | 186.692396 ms |

All runs halted successfully. These are single-run observations on this server,
not universal speedup guarantees. The approximately 128-fold difference at
