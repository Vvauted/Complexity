...
def reader : PolyTimeComponent inputInterface registerInterface (fun x => x) legal where
  ...
  time_polynomial := IsPolynomiallyBounded.const 1
...
def incrementModule : PolyTimeComponent registerInterface registerInterface
  ...
  time_polynomial := IsPolynomiallyBounded.const 25
  size_polynomial := IsPolynomiallyBounded.id.add (IsPolynomiallyBounded.const 1)
...
def doubleModule : PolyTimeComponent registerInterface registerInterface
  ...
  time_polynomial := IsPolynomiallyBounded.const 25
  size_polynomial := (IsPolynomiallyBounded.const 2).mul IsPolynomiallyBounded.id
...
def writer : PolyTimeComponent registerInterface outputInterface (fun x => x)
  ...
  time_polynomial := IsPolynomiallyBounded.const 2
  size_polynomial := IsPolynomiallyBounded.id
